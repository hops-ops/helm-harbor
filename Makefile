...
PACKAGE ?= helm-harbor
XRD_DIR := apis/harbors
COMPOSITION := $(XRD_DIR)/composition.yaml
DEFINITION := $(XRD_DIR)/definition.yaml
EXAMPLE_DEFAULT := examples/harbors/standard.yaml
...
EXAMPLES := \
    examples/harbors/minimal.yaml:: \
    examples/harbors/standard.yaml::
